...
public class HubFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.hubToViewButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        view.findViewById(R.id.hubToNewVehicleId).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_hubFragment_to_newVehicleIdFragment);
            }
        });
